...
if(scrollEnd.current){
  ...
  return selectedUser ? (
   <div className='h-full overflow-scroll relative backdrop-blur-lg'>
    ...
    <img
    onClick={()=>{setSelectedUSer(null)}} src={assets.avatar_icon} alt="" className='md:hidden max-w-7' />
    ...
    <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
      <div className='flex-1 flex items-center bg-gary-100/12 px-3 rounded-full'>
        ...
        <input type="file" name="" id="img" accept='image/png, image/jpeg ' hidden />
        <label htmlFor="image">
